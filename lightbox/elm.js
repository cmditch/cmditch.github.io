...
var _cmditch$elm_web3$Web3_Types$Expect = {ctor: 'Expect'};

var _cmditch$elm_web3$Web3_Internal$expectStringResponse = _cmditch$elm_web3$Native_Web3.expectStringResponse;
var _cmditch$elm_web3$Web3_Internal$Request = F3(
	function (a, b, c) {
		return {func: a, args: b, expect: c};
	});

var _cmditch$elm_web3$Web3$toTask = function (request) {
	return _cmditch$elm_web3$Native_Web3.toTask(request);
};
var _cmditch$elm_web3$Web3$NoWallet = {ctor: 'NoWallet'};
var _cmditch$elm_web3$Web3$BadPayload = function (a) {
	return {ctor: 'BadPayload', _0: a};
};
var _cmditch$elm_web3$Web3$Error = function (a) {
...
var _cmditch$elm_web3$Web3_Eth_Types$NewContract = F2(
	function (a, b) {
		return {txId: a, address: b};
	});
var _cmditch$elm_web3$Web3_Eth_Types$TxParams = F7(
	function (a, b, c, d, e, f, g) {
		return {from: a, to: b, value: c, gas: d, data: e, gasPrice: f, nonce: g};
	});
var _cmditch$elm_web3$Web3_Eth_Types$CallData = F3(
	function (a, b, c) {
		return {abi: a, address: b, args: c};
	});
var _cmditch$elm_web3$Web3_Eth_Types$Block = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
																	...
																	return function (r) {
																		return function (s) {
																			return function (t) {
																				return function (u) {
																					return function (v) {
																						return {author: a, difficulty: b, extraData: c, gasLimit: d, gasUsed: e, hash: f, logsBloom: g, miner: h, mixHash: i, nonce: j, number: k, parentHash: l, receiptsRoot: m, sealFields: n, sha3Uncles: o, size: p, stateRoot: q, timestamp: r, totalDifficulty: s, transactions: t, transactionsRoot: u, uncles: v};
																					};
																				};
																			};
																		};
...
var _cmditch$elm_web3$Web3_Eth_Types$TxReceipt = F8(
	function (a, b, c, d, e, f, g, h) {
		return {transactionHash: a, transactionIndex: b, blockHash: c, blockNumber: d, gasUsed: e, cumulativeGasUsed: f, contractAddress: g, logs: h};
	});
var _cmditch$elm_web3$Web3_Eth_Types$Log = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
					return function (f) {
						return function (g) {
							return function (h) {
								return function (i) {
									return function (j) {
										return {address: a, blockHash: b, blockNumber: c, data: d, logIndex: e, topics: f, transactionHash: g, transactionIndex: h, transactionLogIndex: i, type_: j};
									};
								};
							};
						};
...
var _cmditch$elm_web3$Web3_Decoders$expectJson = function (decoder) {
	return _cmditch$elm_web3$Web3_Internal$expectStringResponse(
		function (r) {
			return A2(_elm_lang$core$Json_Decode$decodeString, decoder, r);
		});
};
var _cmditch$elm_web3$Web3_Decoders$expectInt = _cmditch$elm_web3$Web3_Internal$expectStringResponse(
	function (r) {
		return _elm_lang$core$String$toInt(r);
	});
var _cmditch$elm_web3$Web3_Decoders$bigIntDecoder = function () {
	var convert = function (stringyBigInt) {
		var _p0 = _gilbertkennen$bigint$BigInt$fromString(stringyBigInt);
		if (_p0.ctor === 'Just') {
			return _elm_lang$core$Json_Decode$succeed(_p0._0);
		} else {
			return _elm_lang$core$Json_Decode$fail('Error decoding BigInt');
		}
	};
	return A2(_elm_lang$core$Json_Decode$andThen, convert, _elm_lang$core$Json_Decode$string);
}();

var _cmditch$elm_web3$Web3_Eth_Contract$deployContract = function (evalFunc) {
	return _cmditch$elm_web3$Native_Web3.deployContract(evalFunc);
};
var _cmditch$elm_web3$Web3_Eth_Contract$call = F3(
	function (abi, func, address) {
		return A2(
			_elm_lang$core$Basics_ops['++'],
			'eth.contract(',
			A2(
				...
				A2(
					...
					A2(
						_elm_lang$core$Basics_ops['++'],
						address,
						A2(_elm_lang$core$Basics_ops['++'], '\').', func)))));
	});

var _cmditch$elm_web3$LightBox$data = '';
var _cmditch$elm_web3$LightBox$abi = '[{\"constant\":true,\"inputs\":[],\"name\":\"someNum\",\"outputs\":[{\"name\":\"\",\"type\":\"int8\"}],\"payable\":false,\"type\":\"function\"},{\"constant\":true,\"inputs\":[{\"name\":\"a\",\"type\":\"uint8\"},{\"name\":\"b\",\"type\":\"uint8\"}],\"name\":\"add\",\"outputs\":[{\"name\":\"\",\"type\":\"uint8\"}],\"payable\":false,\"type\":\"function\"},{\"inputs\":[{\"name\":\"someNum_\",\"type\":\"int8\"}],\"payable\":true,\"type\":\"constructor\"},{\"anonymous\":false,\"inputs\":[{\"indexed\":true,\"name\":\"mathematician\",\"type\":\"address\"},{\"indexed\":false,\"name\":\"sum\",\"type\":\"uint8\"}],\"name\":\"Add\",\"type\":\"event\"}]';
var _cmditch$elm_web3$LightBox$add = F3(
	function (address, a, b) {
		return _cmditch$elm_web3$Web3$toTask(
			{
				func: A3(_cmditch$elm_web3$Web3_Eth_Contract$call, _cmditch$elm_web3$LightBox$abi, 'add', address),
				args: _elm_lang$core$Json_Encode$list(
					{
						ctor: '::',
						_0: _elm_lang$core$Json_Encode$int(a),
						_1: {
							ctor: '::',
							_0: _elm_lang$core$Json_Encode$int(b),
							_1: {ctor: '[]'}
						}
					}),
				expect: _cmditch$elm_web3$Web3_Decoders$expectJson(_cmditch$elm_web3$Web3_Decoders$bigIntDecoder)
			});
	});
var _cmditch$elm_web3$LightBox$new = F2(
	function (value, _p0) {
		var _p1 = _p0;
		var ctorArg1 = _gilbertkennen$bigint$BigInt$toString(_p1.someNum_);
		var value_ = A2(
			_elm_lang$core$Maybe$withDefault,
			'0',
			A2(_elm_lang$core$Maybe$map, _gilbertkennen$bigint$BigInt$toString, value));
		var deployFunc = A2(
			_elm_lang$core$Basics_ops['++'],
			'eth.contract(',
			A2(
				_elm_lang$core$Basics_ops['++'],
				_cmditch$elm_web3$LightBox$abi,
				A2(
					_elm_lang$core$Basics_ops['++'],
					').new',
					A2(
												...
												A2(
													...
													A2(
														...
														A2(
															_elm_lang$core$Basics_ops['++'],
															', data: \'',
															A2(_elm_lang$core$Basics_ops['++'], _cmditch$elm_web3$LightBox$data, '\'}, metaMaskCallBack )'))))))))))))));
		return _cmditch$elm_web3$Web3_Eth_Contract$deployContract(deployFunc);
	});
var _cmditch$elm_web3$LightBox$Constructor = function (a) {
	return {someNum_: a};
};
...
var _cmditch$elm_web3$Main$viewError = function (error) {
	var _p0 = error;
	if (_p0.ctor === '[]') {
		return A2(
...
var _cmditch$elm_web3$Main$viewAddress = function (address) {
	var _p1 = address;
	if (_p1.ctor === 'Nothing') {
		return A2(
			_elm_lang$html$Html$div,
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text('Awaiting Address info...'),
				_1: {ctor: '[]'}
			});
	} else {
		return A2(
...
var _cmditch$elm_web3$Main$viewBlock = function (block) {
	var _p2 = block;
	if (_p2.ctor === 'Nothing') {
		return A2(
			_elm_lang$html$Html$div,
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text('Awaiting Block info...'),
				_1: {ctor: '[]'}
			});
	} else {
		return A2(
...
var _cmditch$elm_web3$Main$viewMaybeBigInt = function (mBigInt) {
	var _p3 = mBigInt;
	if (_p3.ctor === 'Nothing') {
		return 'Add';
	} else {
		return _gilbertkennen$bigint$BigInt$toString(_p3._0);
	}
};
var _cmditch$elm_web3$Main$viewContractInfo = function (contract) {
	var _p4 = contract;
	switch (_p4.ctor) {
		case 'UnDeployed':
			return A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('No contract deployed'),
					_1: {ctor: '[]'}
				});
		case 'Deploying':
			return A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Deploying contract...'),
					_1: {ctor: '[]'}
				});
		case 'Deployed':
			var _p6 = _p4._0.txId;
			var _p5 = _p4._0.address;
			return A2(
				_elm_lang$html$Html$div,
				{ctor: '[]'},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Contract TxId: '),
							_1: {
								ctor: '::',
								_0: A2(
									_elm_lang$html$Html$a,
									{
										...
										_1: {
											...
											_0: _elm_lang$html$Html_Attributes$href(
												A2(_elm_lang$core$Basics_ops['++'], 'https://ropsten.etherscan.io/tx/', _p6)),
											_1: {ctor: '[]'}
										}
									},
									{
					...
					_1: {
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('Contract Address: '),
									_1: {
										ctor: '::',
										_0: A2(
											_elm_lang$html$Html$a,
											{
												...
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$href(
														A2(_elm_lang$core$Basics_ops['++'], 'https://ropsten.etherscan.io/address/', _p5)),
													_1: {ctor: '[]'}
												}
											},
											{
		...
		default:
			return A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Error deploying contract.'),
					_1: {ctor: '[]'}
				});
	}
};
var _cmditch$elm_web3$Main$bigBreak = A2(
	_elm_lang$html$Html$div,
	{ctor: '[]'},
	{
		ctor: '::',
...
var _cmditch$elm_web3$Main$Model = F5(
	function (a, b, c, d, e) {
		return {latestBlock: a, contractInfo: b, coinbase: c, additionAnswer: d, error: e};
	});
var _cmditch$elm_web3$Main$ErrorDeploying = {ctor: 'ErrorDeploying'};
var _cmditch$elm_web3$Main$Deployed = function (a) {
	return {ctor: 'Deployed', _0: a};
};
var _cmditch$elm_web3$Main$Deploying = {ctor: 'Deploying'};
var _cmditch$elm_web3$Main$UnDeployed = {ctor: 'UnDeployed'};
var _cmditch$elm_web3$Main$init = A2(
	_elm_lang$core$Platform_Cmd_ops['!'],
	{
		latestBlock: _elm_lang$core$Maybe$Nothing,
		contractInfo: _cmditch$elm_web3$Main$UnDeployed,
		coinbase: '0xe87529a6123a74320e13a6dabf3606630683c029',
		additionAnswer: _elm_lang$core$Maybe$Nothing,
		error: {ctor: '[]'}
	},
	{ctor: '[]'});
var _cmditch$elm_web3$Main$LightBoxAddResponse = function (a) {
	return {ctor: 'LightBoxAddResponse', _0: a};
};
var _cmditch$elm_web3$Main$LightBoxResponse = function (a) {
	return {ctor: 'LightBoxResponse', _0: a};
};
var _cmditch$elm_web3$Main$update = F2(
	function (msg, model) {
		var _p7 = msg;
		switch (_p7.ctor) {
			case 'DeployContract':
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{contractInfo: _cmditch$elm_web3$Main$Deploying}),
					{
						ctor: '::',
						_0: A2(
							_elm_lang$core$Task$attempt,
							_cmditch$elm_web3$Main$LightBoxResponse,
							A2(
								_cmditch$elm_web3$LightBox$new,
								_gilbertkennen$bigint$BigInt$fromString('502030200'),
								{
									someNum_: _gilbertkennen$bigint$BigInt$fromInt(-254)
								})),
						_1: {ctor: '[]'}
					});
			case 'AddNumbers':
				return A2(
					...
					model,
					{
						...
						_0: A2(
							_elm_lang$core$Task$attempt,
							_cmditch$elm_web3$Main$LightBoxAddResponse,
							A3(_cmditch$elm_web3$LightBox$add, _p7._0, _p7._1, _p7._2)),
						_1: {ctor: '[]'}
					});
			case 'LatestResponse':
				var _p8 = _p7._0;
				if (_p8.ctor === 'Ok') {
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{
								latestBlock: _elm_lang$core$Maybe$Just(_p8._0)
							}),
						{ctor: '[]'});
				} else {
					var _p9 = _p8._0;
						...
						case 'Error':
							return A2(
								...
								_elm_lang$core$Native_Utils.update(
									...
									{
										latestBlock: _elm_lang$core$Maybe$Nothing,
										error: {ctor: '::', _0: _p9._0, _1: model.error}
									}),
								{ctor: '[]'});
						case 'BadPayload':
							return A2(
								...
								_elm_lang$core$Native_Utils.update(
									model,
									{
										...
										error: {
											ctor: '::',
											_0: A2(_elm_lang$core$Basics_ops['++'], 'decoding error: ', _p9._0),
											_1: model.error
										}
									}),
								{ctor: '[]'});
						default:
							return A2(
								...
								_elm_lang$core$Native_Utils.update(
									...
									{
										latestBlock: _elm_lang$core$Maybe$Nothing,
										error: {ctor: '::', _0: 'No Wallet Detected', _1: model.error}
									}),
								{ctor: '[]'});
					}
				}
			case 'LightBoxResponse':
				var _p10 = _p7._0;
				if (_p10.ctor === 'Ok') {
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						_elm_lang$core$Native_Utils.update(
							model,
							{
								contractInfo: _cmditch$elm_web3$Main$Deployed(_p10._0)
							}),
						{ctor: '[]'});
				} else {
					var _p11 = _p10._0;
						...
						case 'Error':
							return A2(
								...
								_elm_lang$core$Native_Utils.update(
									model,
									{
										contractInfo: _cmditch$elm_web3$Main$ErrorDeploying,
										error: {ctor: '::', _0: _p11._0, _1: model.error}
									}),
								{ctor: '[]'});
						case 'BadPayload':
							return A2(
								...
								_elm_lang$core$Native_Utils.update(
									model,
									{
										...
										error: {
											ctor: '::',
											_0: A2(_elm_lang$core$Basics_ops['++'], 'decoding error: ', _p11._0),
											_1: model.error
										}
									}),
								{ctor: '[]'});
				...
				if (_p12.ctor === 'Ok') {
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{
								additionAnswer: _elm_lang$core$Maybe$Just(_p12._0)
							}),
						{ctor: '[]'});
				} else {
					var _p13 = _p12._0;
						...
						case 'Error':
							return A2(
								...
								_elm_lang$core$Native_Utils.update(
									...
									{
										additionAnswer: _elm_lang$core$Maybe$Nothing,
										error: {ctor: '::', _0: _p13._0, _1: model.error}
									}),
								{ctor: '[]'});
						case 'BadPayload':
							return A2(
								...
								_elm_lang$core$Native_Utils.update(
									model,
									{
										...
										error: {
											ctor: '::',
											_0: A2(_elm_lang$core$Basics_ops['++'], 'decoding error: ', _p13._0),
											_1: model.error
										}
									}),
								{ctor: '[]'});
...
var _cmditch$elm_web3$Main$LatestResponse = function (a) {
	return {ctor: 'LatestResponse', _0: a};
};
var _cmditch$elm_web3$Main$AddNumbers = F3(
	function (a, b, c) {
		return {ctor: 'AddNumbers', _0: a, _1: b, _2: c};
	});
var _cmditch$elm_web3$Main$viewAddButton = function (model) {
	var _p14 = model.contractInfo;
	if (_p14.ctor === 'Deployed') {
		return A2(
			_elm_lang$html$Html$div,
			{ctor: '[]'},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('You can call LightBox.add(11,12)'),
						_1: {
							ctor: '::',
							_0: A2(
								_elm_lang$html$Html$div,
									...
									_0: A2(
										_elm_lang$html$Html$button,
										{
											...
											_0: _elm_lang$html$Html_Events$onClick(
												A3(_cmditch$elm_web3$Main$AddNumbers, _p14._0.address, 11, 12)),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text(
												_cmditch$elm_web3$Main$viewMaybeBigInt(model.additionAnswer)),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}),
...
var _cmditch$elm_web3$Main$DeployContract = {ctor: 'DeployContract'};
var _cmditch$elm_web3$Main$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onClick(_cmditch$elm_web3$Main$DeployContract),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Touch web3 plz'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: _cmditch$elm_web3$Main$bigBreak,
				_1: {
					ctor: '::',
					_0: _cmditch$elm_web3$Main$viewAddButton(model),
					_1: {
						ctor: '::',
						_0: _cmditch$elm_web3$Main$bigBreak,
						_1: {
							ctor: '::',
							_0: _cmditch$elm_web3$Main$viewContractInfo(model.contractInfo),
							_1: {
								ctor: '::',
								_0: _cmditch$elm_web3$Main$bigBreak,
								_1: {
									ctor: '::',
									_0: _cmditch$elm_web3$Main$viewError(model.error),
									_1: {ctor: '[]'}
								}
							}
						}
...
var _cmditch$elm_web3$Main$main = _elm_lang$html$Html$program(
	{
		init: _cmditch$elm_web3$Main$init,
		view: _cmditch$elm_web3$Main$view,
		update: _cmditch$elm_web3$Main$update,
		subscriptions: _elm_lang$core$Basics$always(_elm_lang$core$Platform_Sub$none)
	})();

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _cmditch$elm_web3$Main$main !== 'undefined') {
    _cmditch$elm_web3$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"BigInt.Magnitude":{"args":[],"tags":{"Magnitude":["List Int"]}},"Main.Msg":{"args":[],"tags":{"LightBoxResponse":["Result.Result Web3.Error Web3.Eth.Types.NewContract"],"AddNumbers":["Web3.Eth.Types.Address","Int","Int"],"DeployContract":[],"LatestResponse":["Result.Result Web3.Error Web3.Eth.Types.Block"],"LightBoxAddResponse":["Result.Result Web3.Error BigInt.BigInt"]}},"Web3.Error":{"args":[],"tags":{"Error":["String"],"NoWallet":[],"BadPayload":["String"]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"BigInt.BigInt":{"args":[],"tags":{"Pos":["BigInt.Magnitude"],"Neg":["BigInt.Magnitude"],"Zer":[]}}},"aliases":{"Web3.Eth.Types.NewContract":{"args":[],"type":"{ txId : Web3.Eth.Types.TxId, address : Web3.Eth.Types.Address }"},"Web3.Eth.Types.Block":{"args":[],"type":"{ author : Web3.Eth.Types.Address , difficulty : BigInt.BigInt , extraData : String , gasLimit : Int , gasUsed : Int , hash : String , logsBloom : String , miner : String , mixHash : String , nonce : String , number : Int , parentHash : String , receiptsRoot : String , sealFields : List String , sha3Uncles : String , size : Int , stateRoot : String , timestamp : Int , totalDifficulty : BigInt.BigInt , transactions : List String , transactionsRoot : String , uncles : List String }"},"Web3.Eth.Types.TxId":{"args":[],"type":"String"},"Web3.Eth.Types.Address":{"args":[],"type":"String"}},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
